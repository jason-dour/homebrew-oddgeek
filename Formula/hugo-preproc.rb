class HugoPreproc < Formula
    ...
    on_macos do
        if Hardware::CPU.arm?
            url "https://github.com/jason-dour/hugo-preproc/releases/download/v2.1.1/hugo-preproc_v2.1.1_darwin_arm64" => "hugo-preproc"
            sha256 "97593a0c9294939c777b320151c4758299b6bba4306e01df5f7a663aa7c7d187"
        else
            url "https://github.com/jason-dour/hugo-preproc/releases/download/v2.1.1/hugo-preproc_v2.1.1_darwin_x64" => "hugo-preproc"
    ...
    on_linux do
        if Hardware::CPU.arm?
            url "https://github.com/jason-dour/hugo-preproc/releases/download/v2.1.1/hugo-preproc_v2.1.1_linux_arm64" => "hugo-preproc"
            sha256 "125ce67596c82de76d311347de140b269cee12e973c029879d51793fca45c31e"
        else
            url "https://github.com/jason-dour/hugo-preproc/releases/download/v2.1.1/hugo-preproc_v2.1.1_linux_x64" => "hugo-preproc"
